...
function renderForget() {
  ...
  let h = '<div style="margin-bottom:24px"><h2 style="font-size:20px;font-weight:700">🧠 \u827e\u5bbe\u6d69\u65af\u9057\u5fd8\u66f2\u7ebf</h2></div>';
  h += '<div class="card card-blue" style="margin-bottom:20px"><div style="font-weight:600;font-size:14px;margin-bottom:8px">📅 \u4eca\u65e5\u590d\u4e60\u63d0\u9192 ('+doneCount+'/'+totalCount+')</div>'+(totalCount>0?'<progress value="'+doneCount+'" max="'+totalCount+'"></progress>':'');
  if(!totalCount) h += '<div style="color:#94a3b8;text-align:center;padding:20px">🎉 \u4eca\u5929\u6ca1\u6709\u5f85\u590d\u4e60\u7684\u5185\u5bb9</div>';
  ...
  h += '<div class="grid-2"><div class="card"><div style="font-weight:600;font-size:14px;margin-bottom:12px">📆 \u660e\u65e5\u590d\u4e60\u9884\u89c8 ('+tomorrowReviews.length+'\u9879)</div>';
  ...
  h += '<div class="card"><div style="font-weight:600;font-size:14px;margin-bottom:12px">📖 \u590d\u4e60\u89c4\u5f8b</div><table><tr><th>\u6b21\u6570</th><th>\u95f4\u9694</th></tr>';
